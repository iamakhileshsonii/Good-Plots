    ...
    try {
      ...
      if (res) {
        toast({
          ...
          description:
            "Congratulation your property initial form has been submitted sucessfully. To verify your property listing complete the KYC form.",
        });
        navigate("/account/pending-properties");
      } else {
        toast({
          title: "Unable to publish property",
          description: "Something went wrong while publishing your property",
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Chandigarh" type="text" {...field} />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="134109" type="number" {...field} />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="1322" type="number" {...field} />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="12000000" type="number" {...field} />
                  </FormControl>
