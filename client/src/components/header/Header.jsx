    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900 border border-b-2">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              ...
              {dropdownVisible && (
                ...
                >
                  <div className="px-4 py-3">
                    ...
                    <span className="block text-sm text-red font-semibold truncate dark:text-gray-400">
                      {authRole}
                    </span>
                  </div>
        ...
        <div
          ...
          id="navbar-user"
        >
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"></ul>
        </div>
      </div>
    </nav>
  );
